...
import cz.kotox.crypto.sdk.configureDetektCompose
...
@Suppress("unused")
class SdkAndroidUiLibraryConventionPlugin : Plugin<Project> {

    override fun apply(target: Project) {
        with(target) {
            configureBasePlugins()
            configureBaseUiModule()
            configureDetektCompose()
            configureSpotless()
        }
    }

    private fun Project.configureBaseUiModule() {
