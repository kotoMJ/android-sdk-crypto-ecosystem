...
public open class IntegrityBuilder(private val context: Context) {
     ...
     */
    public fun setFetchDispatcher(dispatcher: CoroutineDispatcher): IntegrityBuilder {
     ...
     */
    public fun setLoggerCallback(sdkLoggerCallback: SDKLoggerCallback): IntegrityBuilder {
        this.loggerCallback = sdkLoggerCallback
        return this
    }

    public fun build(): Integrity = IntegrityImpl(
        config = IntegrityConfig(
            networkTimeout = networkTimeout,
            loggerCallback = loggerCallback,
        ),
        integrityProvider = IntegrityProvider(context),
