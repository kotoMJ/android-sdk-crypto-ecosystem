...
public object SafeBigDecimalMapNullableSerializer : KSerializer<Map<String, BigDecimal?>> {
    private val delegate = MapSerializer(String.serializer(), SafeNullableBigDecimalSerializer("MapValueNullable"))
