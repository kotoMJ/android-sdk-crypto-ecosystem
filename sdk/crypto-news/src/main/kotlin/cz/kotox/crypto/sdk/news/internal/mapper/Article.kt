 ...
 */
public fun NewsApiResponseDTO.toDomainArticleList(requireTitle: Boolean): Either<SdkError, List<Article>> {
    ...
    return if (this.status != "ok" || this.articles == null) {
        ...
        Either.Value(this.articles.mapNotNull { it.toDomain(requireTitle) })
    }
}
 ...
 */
private fun ArticleDTO.toDomain(requireTitle: Boolean): Article? {
    ...
    if (requireTitle && this.title == null) return null
